...
> 🧭 **本文是 2026-08 的選型紀錄，不是現況。**
> 出貨的 host-kit 走的是 §2.3 的 Cloudflare Quick Tunnel，不是 §2.2 推薦的
> Tailscale 直連——**兩條路的必辦清單與紅線不同**。現況與逐條查核見
> [`DEPLOY-REVISIT.md`](DEPLOY-REVISIT.md)，照這份施工前先看那份。
